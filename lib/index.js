...
var numberableType = (props, propName, componentName) => {
  warning(
    ...
    int or string capable of conversion to an int. Check the render method of
...
class Cropper extends React.Component {
  ...
  componentDidMount () {
    ...
    canvas.addEventListener("mousedown", e => this.mouseDownListener(e), false);
  ...
  componentWillUnmount () {
    ...
    window.removeEventListener("mouseup", this.mouseMoveListener);
